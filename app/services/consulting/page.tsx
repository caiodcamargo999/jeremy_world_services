...
export const metadata: Metadata = {
  ...
  description: 'Strategic business development consulting for high-growth companies. Market expansion, partnerships, and scaling strategies for luxury markets.',
}
...
const benefits = [
  {
    ...
    description: 'Data-driven strategies for market expansion, revenue growth, and competitive positioning'
  },
  {
    icon: Users,
    title: 'Network Access',
    description: 'Exclusive access to industry leaders, investors, and strategic partners worldwide'
  },
  {
    icon: TrendingUp,
    title: 'Scalable Solutions',
    description: 'Proven frameworks and methodologies for sustainable business growth and scaling'
  },
  {
    icon: Zap,
    title: 'Rapid Results',
    description: 'Quick implementation strategies with measurable ROI and performance tracking'
  }
]
...
const services = [
  {
    ...
    description: 'Comprehensive market analysis and entry strategies for new markets',
    duration: '2-4 months'
  },
  {
  ...
  },
  {
    ...
    description: 'Revenue model optimization and growth acceleration strategies',
    duration: '3-6 months'
  },
  {
    name: 'Scale Planning',
    description: 'Business scaling strategies and operational optimization',
    duration: 'Long-term'
  }
]
...
const testimonials = [
  {
    ...
    content: 'Jeremy\'s consulting helped us scale from $1M to $10M in revenue within 18 months.',
    rating: 5
  },
  {
    name: 'Robert Chen',
    title: 'Luxury Brand Founder',
    content: 'The strategic insights and network access were invaluable for our market expansion.',
    rating: 5
  }
]
...
const packages = [
  {
    ...
    price: '$25,000',
    description: 'One-time strategic consultation',
    features: [
      'Market analysis',
      'Growth strategy',
      'Action plan',
  ...
  },
  {
    ...
    price: '$150,000',
    description: 'Comprehensive business development',
    features: [
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-fade-in-up">
            Scale Your Business
            <span className="block bg-gradient-to-r from-gray-100 to-gray-400 bg-clip-text text-transparent"> to New Heights</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto animate-fade-in-up">
            Strategic business development consulting for high-growth companies. Market expansion, 
            partnerships, and scaling strategies designed for luxury markets and premium brands.
          </p>
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700 overflow-hidden relative">
                ...
                <div className="absolute bottom-4 left-4 text-white text-sm">
                  Watch: "The Art of Strategic Business Growth" (6:30)
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up">
            <Link href="/checkout?service=consulting">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              ...
              >
                ...
                <Link href={`/checkout?service=consulting&package=${pkg.name.toLowerCase().replace(' ', '-')}`}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              Join the elite companies who choose Jeremy's World Services for their strategic growth.
            </p>
            <Link href="/checkout?service=consulting">
