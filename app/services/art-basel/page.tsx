...
import { ArrowLeft, Play, Star, Palette, Users, MapPin, Calendar, Zap, Sparkles } from 'lucide-react'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Art Basel & Creative Collabs | Jeremy\'s Lifestyle Ecosystem',
  description: 'Exclusive access to Art Basel and creative collaborations. Connect with world-renowned artists, galleries, and creative opportunities.',
}
...
const benefits = [
  {
    ...
    description: 'VIP access to Art Basel, exclusive galleries, and private art collections worldwide'
  },
  {
    icon: Users,
    title: 'Artist Connections',
    description: 'Direct connections with world-renowned artists and creative professionals'
  },
  {
    icon: Sparkles,
    title: 'Creative Opportunities',
    description: 'Unique collaboration opportunities and creative project development'
  },
  {
    icon: Zap,
    title: 'Instant Access',
    description: 'Last-minute access to sold-out events and exclusive art experiences'
  }
]
...
const services = [
  {
    ...
    description: 'VIP access to Art Basel Miami Beach and international art fairs',
    duration: 'Event-based'
  },
  {
    name: 'Gallery Introductions',
    description: 'Exclusive introductions to top galleries and private collections',
    duration: 'Ongoing'
  },
  {
    name: 'Artist Collaborations',
    description: 'Direct collaboration opportunities with established and emerging artists',
    duration: 'Project-based'
  },
  {
    name: 'Creative Projects',
    description: 'Custom creative projects and artistic development opportunities',
    duration: 'Long-term'
  }
]
...
const testimonials = [
  {
    ...
    title: 'Art Collector',
    content: 'Jeremy\'s connections opened doors to artists and galleries I never thought possible.',
    rating: 5
  },
  {
    name: 'Marcus Johnson',
    title: 'Creative Director',
    content: 'The collaboration opportunities and creative projects exceeded all expectations.',
    rating: 5
  }
]
...
const packages = [
  {
    name: 'Art Basel Pass',
    price: '$25,000',
    description: 'VIP access to Art Basel events',
    features: [
      'VIP Art Basel access',
  ...
  },
  {
    ...
    price: '$100,000',
    description: 'Comprehensive creative collaboration',
    features: [
      'Multiple art fair access',
  ...
  {
    name: 'Elite Art Network',
    price: '$500,000',
    description: 'Exclusive art world access',
    features: [
      'Global art fair access',
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-fade-in-up">
            Access the World's
            <span className="block bg-gradient-to-r from-gray-100 to-gray-400 bg-clip-text text-transparent"> Finest Art</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto animate-fade-in-up">
            Exclusive access to Art Basel and creative collaborations. Connect with world-renowned artists, 
            galleries, and unique creative opportunities in the global art scene.
          </p>
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700 overflow-hidden relative">
                ...
                <div className="absolute bottom-4 left-4 text-white text-sm">
                  Watch: "Inside Art Basel: The Ultimate Art Experience" (4:45)
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up">
            <Link href="/checkout?service=art-basel">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              ...
              >
                ...
                <Link href={`/checkout?service=art-basel&package=${pkg.name.toLowerCase().replace(' ', '-')}`}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              Join the elite who choose Jeremy's World Services for their most exclusive art experiences.
            </p>
            <Link href="/checkout?service=art-basel">
